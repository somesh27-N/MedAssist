...
export function ReportsView() {
  ...
  return (
    <div className="flex flex-col gap-5 animate-fade-in">
      ...
      <Card noPad>
        <CardHeader title="Reports & documents" icon="ti-report-medical" action="Upload" onAction={() => fileInputRef.current.click()}/>
      ...
      >
        <i className="ti ti-cloud-upload text-3xl text-gray-300 block mb-2"/>
        <p className="text-sm font-medium text-gray-400 font-semibold">Drop files here or click to upload</p>
